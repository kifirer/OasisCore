...
public class OsniumIngotItem extends OasiscoreModElements.ModElement {
	@ObjectHolder("oasiscore:osnium_ingot")
	public static final Item block = null;
	public OsniumIngotItem(OasiscoreModElements instance) {
		super(instance, 24);
	}
