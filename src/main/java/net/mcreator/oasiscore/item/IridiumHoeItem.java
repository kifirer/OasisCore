...
public class IridiumHoeItem extends OasiscoreModElements.ModElement {
	@ObjectHolder("oasiscore:iridium_hoe")
	public static final Item block = null;
	public IridiumHoeItem(OasiscoreModElements instance) {
		super(instance, 55);
	}
