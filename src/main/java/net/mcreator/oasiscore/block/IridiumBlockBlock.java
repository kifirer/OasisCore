...
public class IridiumBlockBlock extends OasiscoreModElements.ModElement {
	@ObjectHolder("oasiscore:iridium_block")
	public static final Block block = null;
	public IridiumBlockBlock(OasiscoreModElements instance) {
		super(instance, 47);
	}
