...
public class RhodiumBlockBlock extends OasiscoreModElements.ModElement {
	@ObjectHolder("oasiscore:rhodium_block")
	public static final Block block = null;
	public RhodiumBlockBlock(OasiscoreModElements instance) {
		super(instance, 3);
	}
