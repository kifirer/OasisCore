...
public class WhiteCherryStairsBlock extends OasiscoreModElements.ModElement {
	@ObjectHolder("oasiscore:white_cherry_stairs")
	public static final Block block = null;
	public WhiteCherryStairsBlock(OasiscoreModElements instance) {
		super(instance, 70);
	}
		...
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3.5999999999999996f, 2.4f)
					...
					Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3.5999999999999996f, 2.4f)
							.setLightLevel(s -> 0));
			setRegistryName("white_cherry_stairs");
		}
